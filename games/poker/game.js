...
for(var n=0; n<N; n++) {
    ...
    chips[n][2] = game.add_pieces(5, {...settings, worth:0.1,  worth_prefix:'$', shape:'circle'}, 'red')
    chips[n][3] = game.add_pieces(5, {...settings, worth:0.1,  worth_prefix:'$', shape:'circle'}, 'red')
...
game.add_special_html('<button title="[Shift-Backspace] Collect all chips in the inner play area."   onpointerdown="collect_pot()"      style="margin-left:0.4em; ">Collect Pot</button>')
